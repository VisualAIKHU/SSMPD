...
from datasets import KAISTPed, KAISTPedWSEpoch, KAISTPedWSBatch
from run_epoch import val_epoch, save_results, train_epoch, softTeaching_every_batch
...
def main():
    ...
    if args.soft_teacher.student_checkpoint == args.soft_teacher.teacher_checkpoint:
        ...
        t_model, _, _, _, _ = load_SoftTeacher_3way(config)
    else:
