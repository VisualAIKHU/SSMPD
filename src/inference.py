...
def run_inference(model_path: str, fdz_case: str, input_size) -> Dict:
    ...
    results = val_epoch(model, test_loader, "KAIST", input_size)
    return results
...
if __name__ == '__main__':
    ...
    # Run inference
    results = run_inference(arguments.model_path, fdz_case, input_size)
