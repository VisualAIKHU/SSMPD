...
class RandomResizedCrop(object):
    ...
    def __call__(self, img, mask=None, box_vis=None, box_lwir=None, pair=None):
        ...
        if box_vis is not None and box_lwir is not None:
            ...
            raise ValueError("RandomResizedCrop expects both visible and thermal boxes")
...
class RandomErasing(object):
    def __init__(self, p=0.5, num=(1,5), sl=0.02, sh=0.20, r1=0.3, r2=3.3):
        self.p = p
        self.num = num
        self.sl = sl
        self.sh = sh
    ...
    def __call__(self, img, mask, boxes_vis, boxes_lwir):
        ...
        area = h * w
        erase_num = random.randint(self.num[0], self.num[1])
